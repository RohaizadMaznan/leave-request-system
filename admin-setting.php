<?php 
    ...
    $sql =  "update user set  fullname = '".$_REQUEST['fname']."', 
        ...
        ?>
        <script>
            location.assign("admin-index.php?post_type=setting&submitted=success");
        ...
        echo "<script>location.assign('admin-index.php?post_type=setting&submitted=unsuccess');</script>";
        }
    }
?>
...
if (isset($_REQUEST['submit-pass']))
	...
	if ($database_password == $e_password)
		...
		if ($new_pass == $re_pass)
			...
			echo "<script>window.location='admin-index.php?post_type=setting&submitted=success-pass'</script>";
			
			}
		  else
			{
			    
			echo "<script>window.location='admin-index.php?post_type=setting&submitted=unsuccess-pass'</script>";
			}
		}
	  else
		{
			...
			echo "<script>window.location='admin-index.php?post_type=setting&submitted=oldpasswrong'</script>";
